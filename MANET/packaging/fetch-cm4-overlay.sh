...
#  into kernel-work/packages/cm4-sbc-overlay — untracked in git (see
...
OVERLAY_DIR="$(cd "$SCRIPT_DIR/../.." && pwd)/kernel-work/packages/cm4-sbc-overlay"
...
(\`curl -sI $SOURCE_URL\`) against the value above.
EOF
