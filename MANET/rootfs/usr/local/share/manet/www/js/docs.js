...
'<h3>Performance</h3>',
'<table class="docs-table"><thead><tr><th>Method</th><th>Endpoint</th><th>Description</th></tr></thead><tbody>',
'<tr><td>POST</td><td><code>/api/iperf/server</code></td><td>Start iperf3 server on this node</td></tr>',
'<tr><td>POST</td><td><code>/api/iperf/client</code></td><td>Run iperf3 client test to a target</td></tr>',
'<tr><td>GET</td><td><code>/api/iperf/stream</code></td><td>Stream iperf3 output (SSE)</td></tr>',
'<tr><td>POST</td><td><code>/api/iperf/stop</code></td><td>Stop iperf3</td></tr>',
'<tr><td>POST</td><td><code>/api/ping/run</code></td><td>Run ping test to a target</td></tr>',
'<tr><td>GET</td><td><code>/api/ping/stream</code></td><td>Stream ping output (SSE)</td></tr>',
'<tr><td>POST</td><td><code>/api/ping/stop</code></td><td>Stop ping</td></tr>',
'</tbody></table>',
